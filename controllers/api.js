...
/**
 * GET /api/programs
 * List all Program Data.
 */
 exports.getPrograms = (req, res, next) => {
  request('https://api.myjson.com/bins/5bdb3', function (error, response, body) {
...
/**
 * GET /api/pricing
 * List all Pricing Data.
 */
 exports.getPricing = (req, res, next) => {
  request('https://api.myjson.com/bins/47axv', function (error, response, body) {
    if (error) { return next(error); }
    res.send(body);
  });
};
